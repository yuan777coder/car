...
/* ==========================================================================
 *  oled_font.c  —  SSD1306 6x8 ASCII 点阵字库
 *
 *  数据来源：Adafruit GFX Library 官方 5x7 经典字库 glcdfont.c
 *  https://raw.githubusercontent.com/adafruit/Adafruit-GFX-Library/master/glcdfont.c
 *  取原数组索引 0x20~0x7F（第 32~127 项，共 96 字符），每字符 5 字节，
 *  末尾补 1 个 0x00 作字符间距，得到 6 字节/字符，共 96*6 = 576 字节。
 *  原始字节序为“列优先、LSB 在上”，与 SSD1306 页显存一致，未做任何翻转。
 * ========================================================================== */

const uint8 OledFont6x8[96][6] = {
